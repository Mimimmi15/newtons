...
model = ADNLPModel(f, [1.0, 1.0])
x1 = newton_modifiee(model)
x2 = newton_inexacte(model)
```
...
test3 = OptimizationProblems.ADNLPProblems.qqchose()
...
```{julia}
test1 = OptimizationProblems.ADNLPProblems.qqchos()
x1 = newton_inexacte(test1)
test2 = OptimizationProblems.ADNLPProblems.qqchos()
x2 = newton_inexacte(test2)
test3 = OptimizationProblems.ADNLPProblems.qqchos()
